defmodule CyaneaWeb.SettingsLive do
  ...
  def handle_event("save", %{"user" => user_params}, socket) do
    ...
    safe_params = Map.take(user_params, ["name", "bio", "readme", "affiliation", "avatar_url"])
      ...
      {:error, :no_password} ->
        {:noreply,
         put_flash(
           socket,
           :error,
           "Cannot unlink ORCID: you must set a password first to avoid being locked out."
         )}
    end
  end
    ...
    <div class="mx-auto max-w-2xl">
        ...
        <.simple_form for={@form} phx-change="validate" phx-submit="save">
            ...
            <img
              src={
                @current_user.avatar_url ||
                  "https://api.dicebear.com/7.x/initials/svg?seed=#{@current_user.username}"
              }
          ...
          <div>
            <.input
              ...
              rows="8"
              placeholder="Shown on your profile page. Markdown supported."
            />
            <p class="mt-1 text-sm text-slate-500">
              Rendered on your public profile. Supports Markdown.
            </p>
          </div>
          <.input
            field={@form[:affiliation]}
            type="text"
            label="Affiliation"
      ...
      <div class="mt-8 rounded-xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-slate-800">
        ...
        <div
          ...
          class="mt-4 flex items-center justify-between rounded-lg border border-slate-200 p-4 dark:border-slate-700"
        >
          <div class="flex items-center gap-3">
            <svg class="h-6 w-6" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
              ...
              />
              <path
                d="M86.3 186.2H70.9V79.1h15.4v107.1zM108.9 79.1h41.6c39.6 0 57 28.3 57 53.6 0 27.5-21.5 53.6-56.8 53.6h-41.8V79.1zm15.4 93.3h24.5c34.9 0 42.9-26.5 42.9-39.7 0-21.5-13.7-39.7-43-39.7h-24.4v79.4zM78.6 60.6c-5.7 0-10.3 4.6-10.3 10.3s4.6 10.3 10.3 10.3 10.3-4.6 10.3-10.3-4.6-10.3-10.3-10.3z"
                fill="#FFF"
              />
            </svg>
