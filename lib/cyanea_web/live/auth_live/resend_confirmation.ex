defmodule CyaneaWeb.AuthLive.ResendConfirmation do
  ...
  def handle_event("send_instructions", %{"user" => %{"email" => email}}, socket) do
    ...
    {:noreply,
     socket
     |> put_flash(:info, "If that email is in our system and has not been confirmed yet, you will receive an email with instructions shortly.")
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-md py-12">
      <div class="text-center">
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Resend confirmation email</h1>
        <p class="mt-2 text-sm text-slate-600 dark:text-slate-400">
          Enter your email and we'll resend the confirmation instructions.
        </p>
      </div>
